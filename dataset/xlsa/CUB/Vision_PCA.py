...
test_unseen_num, _ = test_x_unseen.shape
test_seen_num, _ = test_x_seen.shape
sampled_num, _ = batch_visual_concat.shape
train_test_data = np.concatenate([test_x_unseen, test_x_seen, batch_visual_concat], axis=0)# [test_num+train_num+1+sampled_num, v]
print('start PCA')
