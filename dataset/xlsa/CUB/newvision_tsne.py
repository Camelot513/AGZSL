...
matcontent = io.loadmat("C:/someproject/ZSLearning/AGZSL-main/dataset/xlsa/APY/res101.mat")

feature = matcontent['features'].T
print(feature.shape)
label = matcontent['labels'].astype(int).squeeze() - 1
matcontent = io.loadmat("C:/someproject/ZSLearning/AGZSL-main/dataset/xlsa/APY/att_splits.mat")
...
plt.title('APY Vision')
plt.show()
plt.close()

# main task 1: visualize semantic space (and more datasets)
# main task 2: take the reproduce table
# minor task 1: set class colors
